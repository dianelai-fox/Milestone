...
function renderServerStatus() {
  ...
  copy.textContent = `${visible.length} of ${servers.length} non-XProtect servers across ${groups.length} application${groups.length === 1 ? "" : "s"}. Services show Running or Stopped after you grant the XProtectDashboard app pool remote WMI (scripts/grant-remote-service-access.ps1).`;
