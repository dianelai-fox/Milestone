...
public sealed class DemoVmsClient : IVmsClient
{
    ...
    public Task<DashboardSnapshot> GetSnapshotAsync(CancellationToken cancellationToken)
    {
        ...
        var cameras = new List<CameraInfo>
        {
            ...
            Cam("c04", "Elevator Bank A", "Building A", rec1, "REC-01 Downtown", -118.2563, 34.0526, true, "10.10.1.14", "Hanwha PNV-A6081R", "2.21.10", ["Building A / Elevators"], "Hanwha Wisenet"),
            ...
            Cam("c07", "Loading Dock", "Building A", rec1, "REC-01 Downtown", -118.2558, 34.0510, true, "10.10.1.31", "Bosch FLEXIDOME 5100i", "8.81.0060", ["Building A / Dock"], "Bosch"),
